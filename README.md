...
function trigger(exploit_addr){
	...
	if (document.getElementById('trigger').innerHTML.indexOf("NaN") != -1) {
		document.write("<html><h1><span style='color:red'>¡Debe instalar el firmware híbrido (HFW) antes de instalar HEN!</h1></span></html>");
		return;
	}
}
function load_check()
...
function triggerX()
{
	...
	setTimeout(showResult,2000,"<h1>Listo ya puede descargar Hen</h1><h2>1. Cierra el navegador<br>2. Abra uso a distancia, en el momento que ya este dentro precionar circulo<br>3. Valla arriba de uso a distacia y use el nuevo icono para descargar e instalar HEN</span><br>4. Reinicia la consola despues de la instalacion<br><br>Team Maxistore.</h2>");
	t_out=0;
	total_loops=0;
}
initROP(true);
